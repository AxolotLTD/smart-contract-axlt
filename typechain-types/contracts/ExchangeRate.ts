...
export interface ExchangeRateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getExchangeRate"
      | "owner"
...
export interface ExchangeRate extends BaseContract {
  connect(runner?: ContractRunner | null): ExchangeRate;
